...
package org.xdty.authenticator.androidlockpattern.util;
...
public class Settings {
    ...
    public static class Display {
        ...
        public static boolean isStealthMode(Context context) {
            return p(context)
                    .getBoolean(
                            context.getString(R.string.pkey_display_stealth_mode),
                            context.getResources()
                                    .getBoolean(
                                            R.bool.pkey_display_stealth_mode_default));
        }// isStealthMode()
        ...
        public static int getMinWiredDots(Context context) {
            return p(context)
                    .getInt(context
                                    .getString(R.string.pkey_display_min_wired_dots),
                            context.getResources()
                                    .getInteger(
                                            R.integer.pkey_display_min_wired_dots_default));
        }// getMinWiredDots()
        ...
        public static int getMaxRetries(Context context) {
            return p(context)
                    .getInt(context
                                    .getString(R.string.pkey_display_max_retries),
                            context.getResources()
                                    .getInteger(
                                            R.integer.pkey_display_max_retries_default));
        }// getMaxRetries()
        ...
        public static int getCaptchaWiredDots(Context context) {
            return p(context)
                    .getInt(context
                            ...
                            context.getResources()
                                    .getInteger(
                                            R.integer.pkey_display_captcha_wired_dots_default));
        }// getCaptchaWiredDots()
    ...
    public static class Security {
        ...
        public static boolean isAutoSavePattern(Context context) {
            return p(context)
                    .getBoolean(
                            context.getString(R.string.pkey_sys_auto_save_pattern),
                            context.getResources()
                                    .getBoolean(
                                            R.bool.pkey_sys_auto_save_pattern_default));
        }// isAutoSavePattern()
        ...
        public static char[] getPattern(Context context) {
            String pattern = p(context).getString(
                    context.getString(R.string.pkey_sys_pattern),
                    null);
        ...
        public static char[] getEncrypterClass(Context context) {
            String clazz = p(context)
                    .getString(
                            context.getString(R.string.pkey_sys_encrypter_class),
                            null);

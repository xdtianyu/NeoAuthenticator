...
public class SimpleWeakEncryption {
     ...
     * @throws RuntimeException which wraps {@link UnsupportedEncodingException} in case the
     ...
     * @throws RuntimeException which wraps {@link NoSuchAlgorithmException} in case the
